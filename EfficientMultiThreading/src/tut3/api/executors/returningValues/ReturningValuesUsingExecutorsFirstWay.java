...
public class ReturningValuesUsingExecutorsFirstWay {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Waiting to get the result-5");
			System.out.println("Result-1 = " + result1.get());
			System.out.println("Waiting to get the result-1");
			System.out.println("Result-2 = " + result2.get());
			System.out.println("Waiting to get the result-2");
			System.out.println("Result-3 = " + result3.get());
			System.out.println("Waiting to get the result-3");
			System.out.println("Result-4 = " + result4.get());
			System.out.println("Waiting to get the result-4");
